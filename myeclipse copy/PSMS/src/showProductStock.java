...
if(v.size()>0)
{
	...
	pw.println("<body><form name=updateProductStock method=post action='./updateproductstock'>");
...
{
	pw.println("<html><head><TITLE>Web-Enabled Automated Manufacturing System</TITLE></script></head><P align=center><FONT color=deepskyblue size=4><STRONG>MODIFY&nbsp;PRODUCT </STRONG></FONT></P> ");
	pw.println("<center><strong><b>The Products are not there with respect to the dealer</b></strong>");
